...
public class OrderController {
    ...
    public EntityModel<Order> single(@PathVariable Long id) {
    ...
    public ResponseEntity<EntityModel<Order>> createOrder(@RequestBody Order order) {
        ...
        return ResponseEntity.created(linkTo(methodOn(OrderController.class).single(newOrder.getId())).toUri()).body(assembler.toModel(newOrder));
    }
